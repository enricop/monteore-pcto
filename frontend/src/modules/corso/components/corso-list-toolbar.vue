...
export default Vue.extend({
  name: 'app-corso-list-toolbar',

  computed: {
    ...mapGetters({
      currentUser: 'auth/currentUser',
      currentTenant: 'auth/currentTenant',
      hasRows: 'corso/list/hasRows',
      loading: 'corso/list/loading',
      exportLoading: 'corso/list/exportLoading',
      selectedRows: 'corso/list/selectedRows',
  ...
  methods: {
    ...mapActions({
      doExport: 'corso/list/doExport',
      doRemoveAllSelected:
        'corso/list/doRemoveAllSelected',
      doDisableAllSelected:
        'corso/list/doDisableAllSelected',
      doEnableAllSelected:
        'corso/list/doEnableAllSelected',
      doDestroyAll: 'corso/destroy/doDestroyAll',
    }),
