...
<script lang="ts">
import CorsoFormModal from '@/modules/corso/components/corso-form-modal.vue';
import { CorsoPermissions } from '@/modules/corso/corso-permissions';
import { mapGetters } from 'vuex';

import Vue from 'vue';
export default Vue.extend({
  name: 'app-corso-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    'app-corso-form-modal': CorsoFormModal,
  },
