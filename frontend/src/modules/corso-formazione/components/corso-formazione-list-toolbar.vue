<template>
  <div class="app-page-toolbar">
    ...
    <router-link
      :to="{ path: '/corso-formazione/import' }"
    ...
    <router-link
      :to="{
        path: '/audit-logs',
        query: { entityNames: 'corsoFormazione' },
      }"
...
export default Vue.extend({
  name: 'app-corso-formazione-list-toolbar',

  computed: {
    ...mapGetters({
      currentUser: 'auth/currentUser',
      currentTenant: 'auth/currentTenant',
      hasRows: 'corsoFormazione/list/hasRows',
      loading: 'corsoFormazione/list/loading',
      exportLoading: 'corsoFormazione/list/exportLoading',
      selectedRows: 'corsoFormazione/list/selectedRows',
  ...
  methods: {
    ...mapActions({
      doExport: 'corsoFormazione/list/doExport',
      doRemoveAllSelected:
        'corsoFormazione/list/doRemoveAllSelected',
      doDisableAllSelected:
        'corsoFormazione/list/doDisableAllSelected',
      doEnableAllSelected:
        'corsoFormazione/list/doEnableAllSelected',
      doDestroyAll: 'corsoFormazione/destroy/doDestroyAll',
    }),
