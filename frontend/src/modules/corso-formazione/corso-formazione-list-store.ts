...
import corsoFormazioneListExporterFields from '@/modules/corso-formazione/corso-formazione-list-exporter-fields';
...
export default {
  ...
  actions: {
    ...
    async doExport({ commit, getters }) {
      try {
        if (
          !corsoFormazioneListExporterFields ||
          !corsoFormazioneListExporterFields.length
        ) {
          throw new Error(
            'corsoFormazioneListExporterFields is required',
          );
        }
        ...
        const response = await CorsoFormazioneService.list(
          filter,
          getters.orderBy,
          null,
          null,
