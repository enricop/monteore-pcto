<template>
  <div class="app-page-toolbar">
    ...
    <router-link
      :to="{ path: '/ciclo-monte-ore/import' }"
    ...
    <router-link
      :to="{
        path: '/audit-logs',
        query: { entityNames: 'cicloMonteOre' },
      }"
...
export default Vue.extend({
  name: 'app-ciclo-monte-ore-list-toolbar',

  computed: {
    ...mapGetters({
      currentUser: 'auth/currentUser',
      currentTenant: 'auth/currentTenant',
      hasRows: 'cicloMonteOre/list/hasRows',
      loading: 'cicloMonteOre/list/loading',
      exportLoading: 'cicloMonteOre/list/exportLoading',
      selectedRows: 'cicloMonteOre/list/selectedRows',
  ...
  methods: {
    ...mapActions({
      doExport: 'cicloMonteOre/list/doExport',
      doRemoveAllSelected:
        'cicloMonteOre/list/doRemoveAllSelected',
      doDisableAllSelected:
        'cicloMonteOre/list/doDisableAllSelected',
      doEnableAllSelected:
        'cicloMonteOre/list/doEnableAllSelected',
      doDestroyAll: 'cicloMonteOre/destroy/doDestroyAll',
    }),
