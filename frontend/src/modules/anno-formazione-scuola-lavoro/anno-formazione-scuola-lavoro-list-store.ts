...
import annoFormazioneScuolaLavoroListExporterFields from '@/modules/anno-formazione-scuola-lavoro/anno-formazione-scuola-lavoro-list-exporter-fields';
...
export default {
  ...
  actions: {
    ...
    async doExport({ commit, getters }) {
      try {
        if (
          !annoFormazioneScuolaLavoroListExporterFields ||
          !annoFormazioneScuolaLavoroListExporterFields.length
        ) {
          throw new Error(
            'annoFormazioneScuolaLavoroListExporterFields is required',
          );
        }
        ...
        const response = await AnnoFormazioneScuolaLavoroService.list(
          filter,
          getters.orderBy,
          null,
          null,
