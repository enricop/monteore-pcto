<template>
  <div class="app-page-toolbar">
    <router-link
      :to="{ path: '/anno-formazione-scuola-lavoro/new' }"
    ...
    <router-link
      :to="{ path: '/anno-formazione-scuola-lavoro/import' }"
    ...
    <router-link
      :to="{
        path: '/audit-logs',
        query: { entityNames: 'annoFormazioneScuolaLavoro' },
      }"
...
export default Vue.extend({
  name: 'app-anno-formazione-scuola-lavoro-list-toolbar',

  computed: {
    ...mapGetters({
      currentUser: 'auth/currentUser',
      currentTenant: 'auth/currentTenant',
      hasRows: 'annoFormazioneScuolaLavoro/list/hasRows',
      loading: 'annoFormazioneScuolaLavoro/list/loading',
      exportLoading: 'annoFormazioneScuolaLavoro/list/exportLoading',
      selectedRows: 'annoFormazioneScuolaLavoro/list/selectedRows',
  ...
  methods: {
    ...mapActions({
      doExport: 'annoFormazioneScuolaLavoro/list/doExport',
      doRemoveAllSelected:
        'annoFormazioneScuolaLavoro/list/doRemoveAllSelected',
      doDisableAllSelected:
        'annoFormazioneScuolaLavoro/list/doDisableAllSelected',
      doEnableAllSelected:
        'annoFormazioneScuolaLavoro/list/doEnableAllSelected',
      doDestroyAll: 'annoFormazioneScuolaLavoro/destroy/doDestroyAll',
    }),
