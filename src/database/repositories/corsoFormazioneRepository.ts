...
class CorsoFormazioneRepository {
  ...
  static async create(data, options: IRepositoryOptions) {
    ...
    await FileRepository.replaceRelationFiles(
      {
        belongsTo: options.database.corsoFormazione.getTableName(),
  ...
  static async update(id, data, options: IRepositoryOptions) {
    ...
    let record = await options.database.corsoFormazione.findOne(      
      {
        where: {
          id,
  ...
  static async findById(id, options: IRepositoryOptions) {
    ...
    const record = await options.database.corsoFormazione.findOne(
      {
        where: {
          id,
          tenantId: currentTenant.id,
  ...
  static async count(filter, options: IRepositoryOptions) {
    ...
    return options.database.corsoFormazione.count(
      {
        where: {
          ...filter,
          tenantId: tenant.id,
  ...
  static async findAndCountAll(
    ...
    let {
      rows,
      count,
    } = await options.database.corsoFormazione.findAndCountAll({
      where,
      include,
...
export default CorsoFormazioneRepository;
